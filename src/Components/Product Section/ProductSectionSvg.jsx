export function ProductSVGSort() {
    return (
...
export function ProductSVGFilter() {
    return (
        <svg className="-mr-1 h-5 w-5 text-gray-400" viewBox="0 0 20 20" fill="currentColor" aria-hidden="true">
            <path
                fillRule="evenodd"
...
export function ProductSVGAddToCart() {
    return (
        <svg
...
export function ProductSVGLoading() {
    return (
